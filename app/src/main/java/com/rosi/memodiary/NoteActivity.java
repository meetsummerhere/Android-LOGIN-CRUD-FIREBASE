...
import com.rosi.memodiary.adapter.MainAdapter;
import com.rosi.memodiary.model.ModelBarang;
...
public class NoteActivity extends AppCompatActivity implements MainAdapter.FirebaseDataListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseReference.child("data_barang").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mAdapter = new MainAdapter(NoteActivity.this, daftarBarang);
        ...
        builder.setPositiveButton("SIMPAN", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                if (!namaBarang.isEmpty() && !merkBarang.isEmpty() && !hargaBarang.isEmpty()) {
                    ...
                    Toast.makeText(NoteActivity.this, "Data harus di isi!", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    private void submitDataBarang(ModelBarang barang) {
        mDatabaseReference.child("data_barang").push()
            ...
            public void onSuccess(Void mVoid) {
                Toast.makeText(NoteActivity.this, "Data barang berhasil di simpan !", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void updateDataBarang(ModelBarang barang) {
        mDatabaseReference.child("data_barang").child(barang.getKey())
            ...
            @Override
            public void onSuccess(Void mVoid) {
                Toast.makeText(NoteActivity.this, "Data berhasil di update !", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void hapusDataBarang(ModelBarang barang) {
        if (mDatabaseReference != null) {
            mDatabaseReference.child("data_barang").child(barang.getKey())
                ...
                @Override
                public void onSuccess(Void mVoid) {
                    Toast.makeText(NoteActivity.this, "Data berhasil di hapus !", Toast.LENGTH_LONG).show();
                }
            });
        }
    }
